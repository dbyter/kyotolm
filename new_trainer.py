...
parser.add_argument("--grad_accum_steps", type=int, default=6, help="Gradient accumulation steps (effective_batch = batch_size * grad_accum_steps)")
...
for epoch in range(start_epoch, args.max_epochs):
    ...
    for batch_idx, (x, y) in enumerate(loader):
        ...
        is_accum_step = ((batch_idx + 1) % args.grad_accum_steps != 0) and (batch_idx + 1 < len(loader))
